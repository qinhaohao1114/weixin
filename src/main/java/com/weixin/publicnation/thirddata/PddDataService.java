...
public class PddDataService {
    ...
    private String recomendGoodUrl="http://mobile.yangkeduo.com/proxy/api/api/barrow/query?app_name=rectab_sim_gyl&support_types=0_1&offset=80&count=60&list_id=5OYP4rGW4n&dp_list_id=5OYP4rGW4n_dp&pdduid=2776961672086";
...
//        JSONObject jsonObject= (JSONObject) JSONObject.toJSON(body);
    ...
    public void recomendGood(){
        ...
        String body = stringResponseEntity.getBody();
        List<Good> goods = JSONObject.parseArray(body, Good.class);
